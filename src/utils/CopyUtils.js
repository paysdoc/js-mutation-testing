...
var fs = require('fs-extra'),
    ...
    path = require('path'),
    q = require('q'),
    temp = require('temp').track(); // use (chainable) track to remove files after the process

/**
 * Copy a file or array of files to a temporary directory. File paths may contain wildcards,
 * e.g. test/*Spec.js
 *
 * @param {string | [string]} files filepath or array of filepaths that will be copied
